...
const CheckOutPage = () => {
  ...
  return (
    <div className="sm:flex sm:p-5 gap-x-10">
      ...
      <div className=" bg-violet-200 w-full fixed sm:sticky bottom-0 gap-x-10 flex justify-between p-2 sm:right-0 sm:top-0 sm:flex-col sm:max-w-[250px] max-h-36 sm:min-h-[9rem] sm:rounded-sm">
